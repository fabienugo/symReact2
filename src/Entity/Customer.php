...
class Customer
{
    ...
    /**
     * Retourne le montant total des factures pour un customer
     * @Groups({"customers_read"})
     * 
     * @return float
     */
    ...
    /**
     * Retourne le montant total non payé par le customer
     * @Groups({"customers_read"})
     * 
     * @return float
     */
    public function getUnpaidAmount(): float {
        return array_reduce($this->invoices->toArray(), function($total, $invoice) {
            return $total + ($invoice->getStatus() !== "SENT"  ? 0 : $invoice->getAmount());
        }, 0);
    }
